<script>
    ...
    const url =
        "https://raw.githubusercontent.com/temidaradev/xmrig-dashboard/master/README.md";

    const fallbackContent = `\n# XMRig Dashboard\n\nA web-based dashboard for monitoring and controlling XMRig cryptocurrency miner.\n`;
    ...
    {#if isLoading}
        <div class="flex justify-center items-center h-40" in:fade>
            <div class="loading-container">
                <span class="text-pink-400 text-xl">Loading XMRig Dashboard...</span>
