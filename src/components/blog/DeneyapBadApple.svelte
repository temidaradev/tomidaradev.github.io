<script>
    ...
    const url =
        "https://raw.githubusercontent.com/temidaradev/DeneyapA1V2-BadApple/master/README.md";

    const fallbackContent = `\n# ESP32 Bad Apple\n\nBad Apple video on ESP32 with SSD1306 OLED, using Heatshrink compression for video storage.\n`;
    ...
    {#if isLoading}
        <div class="flex justify-center items-center h-40" in:fade>
            <div class="loading-container">
                <span class="text-pink-400 text-xl">Loading ESP32 Bad Apple...</span>
