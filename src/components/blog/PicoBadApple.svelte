<script>
    ...
    const url =
        "https://raw.githubusercontent.com/temidaradev/pico2-riscv-badapple/master/README.md";

    const fallbackContent = `\n# Bad Apple on RP2350 (RISC-V)\n\nPlaying the iconic "Bad Apple" video on a Raspberry Pi Pico 2 (RP2350) using the RISC-V hazard3 cores and SSD1306 OLED.\n`;
    ...
    {#if isLoading}
        <div class="flex justify-center items-center h-40" in:fade>
            <div class="loading-container">
                <span class="text-pink-400 text-xl">Loading Bad Apple Project...</span>
